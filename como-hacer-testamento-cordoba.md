...
faq:
  - q: "¿Necesito un escribano para hacer un testamento?"
    a: "Para el testamento por acto público sí. El testamento ológrafo no requiere escribano al otorgarse, pero debe cumplir estrictamente sus requisitos y después del fallecimiento necesita comprobación judicial y protocolización."
  - q: "¿Puedo escribir mi testamento en computadora?"
    a: "Un texto impreso o escrito por otra persona no cumple el requisito del testamento ológrafo. Para esa forma debe estar íntegramente escrito, fechado y firmado por la mano del testador."
  - q: "¿Puedo dejarle todo a una sola persona?"
    a: "Solamente dentro de los límites legales. Si existen descendientes, ascendientes o cónyuge, hay porciones legítimas protegidas. Antes de fijar porcentajes conviene revisar patrimonio, familia y donaciones previas."
  - q: "¿Cuánto cuesta hacer un testamento en Córdoba?"
    a: "No hay un precio único aplicable a todos los casos. En el testamento por acto público deben consultarse los honorarios y gastos notariales vigentes. El costo real también depende del asesoramiento y de la complejidad patrimonial y familiar."
  - q: "¿Puedo cambiar o revocar mi testamento?"
    a: "Sí. El testamento es revocable mientras vive el testador. La modificación o revocación debe instrumentarse respetando las formalidades correspondientes."
  - q: "¿Un matrimonio posterior puede afectar el testamento?"
    a: "Sí. El Código prevé que el matrimonio posterior revoca el testamento anterior, salvo las excepciones establecidas por la ley. Por eso conviene revisar el documento después de cambios familiares importantes."
---

## Respuesta rápida

Para **hacer un testamento en Córdoba** no alcanza con expresar informalmente cómo deberían repartirse los bienes. La voluntad debe quedar plasmada en una de las formas admitidas por la ley y respetar las porciones legítimas de determinados familiares.

El [Código Civil y Comercial actualizado](https://www.argentina.gob.ar/normativa/nacional/ley-26994-235975/actualizacion) permite testar a las personas mayores de edad. La decisión es personal e indelegable: dos personas no pueden otorgar un único testamento conjunto.
...
Esta alternativa permite trabajar previamente la redacción y conservar un antecedente notarial, pero tampoco habilita a vulnerar la legítima ni evita la futura [sucesión con testamento](/sucesion-con-testamento-cordoba/).
...
Si el fallecimiento ya ocurrió, la consulta adecuada no es cómo redactarlo sino [cómo se tramita una sucesión testamentaria](/sucesion-con-testamento-cordoba/). Para ordenar una situación concreta, podés solicitar una [evaluación profesional](/abogado-sucesiones-cordoba/) o escribir desde [contacto](/contacto/).
