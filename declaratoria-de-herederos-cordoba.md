...
faq:
  ...
  - q: "¿Siempre hay que hacer declaratoria?"
    a: "En la sucesión intestada, cuando hace falta acreditar herederos frente a terceros, registros, bancos u organismos, normalmente sí. Si existe testamento, el trámite cambia y debe analizarse si corresponde sucesión testamentaria, protocolización y/o declaración de validez formal."
  - q: "¿Qué documentación mínima conviene tener a mano?"
    a: "Como base: acta o partida de defunción, partidas para acreditar vínculo (nacimiento o matrimonio, según corresponda), datos de los herederos y último domicilio del causante. Si hay bienes, ayudan datos orientativos: matrícula o dirección del inmueble, dominio del automotor, entidad bancaria, etc."
  - q: "¿Cuánto tarda una declaratoria en Córdoba?"
    a: "No hay un plazo único. Depende del tribunal, de la documentación, de la correcta acreditación de vínculos, de las notificaciones y edictos, y de si existe o no conflicto. Un caso ordenado suele demorar varios meses; con observaciones o controversia puede extenderse bastante más."
  - q: "¿El conviviente hereda igual que el cónyuge?"
    a: "No. La unión convivencial no coloca al conviviente dentro del orden de vocación hereditaria intestada del Código Civil y Comercial. Eso no impide que, según el caso, existan otros derechos específicos, como la eventual atribución habitacional prevista por la ley."
---
...
6) **Enviar documentación sensible por vías inseguras**.
