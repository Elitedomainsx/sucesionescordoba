---
layout: article
title: "Un heredero no quiere vender"
title_category: "Opciones legales"
seo_title: "Un heredero no quiere vender: opciones legales"
h1: "Qué hacer si un heredero no quiere vender la casa heredada"
description: "Opciones cuando un heredero quiere vender una casa y otro se opone: negociación, tasación, adjudicación, compensación y partición en Córdoba."
primary_keyword: "un heredero no quiere vender"
page_topic: "heredero_no_vende"
date: 2026-09-02
...
image:
  ...
  width: 1200
  height: 630
  alt: "Herederos analizan qué hacer con una casa que uno no quiere vender"
reviewed_by:
  - pablo
  - gustavo
official_sources:
...
quick: "Un heredero no puede ser obligado informalmente a firmar una venta privada, pero tampoco tiene necesariamente un derecho a mantener la indivisión para siempre. Primero conviene precisar el conflicto y evaluar tasación, compra de partes, adjudicación, compensación o venta acordada; si no hay solución, puede corresponder la partición judicial."
whatsapp_message: "Hola, tenemos una propiedad heredada en Córdoba y un heredero no quiere vender. Somos ___ herederos, la sucesión está en etapa ___ y el objetivo es ___."
whatsapp_cta_label: "Evaluar opciones entre herederos"
cta_title: "¿La propiedad está bloqueada por falta de acuerdo?"
cta_copy: "Contanos en qué etapa está la sucesión, quién ocupa el inmueble, qué propone cada heredero y si existe una tasación actual."
faq:
  - q: "¿La mayoría de los herederos puede vender sin el que se opone?"
    a: "No debe suponerse que una mayoría puede transferir el inmueble completo sin la intervención necesaria de todos los titulares de derechos. Debe analizarse la operación y, si no hay acuerdo, la partición."
  - q: "¿El heredero que vive en la casa tiene más derecho?"
    a: "La ocupación por sí sola no aumenta su porción hereditaria. Sin embargo, el uso, los acuerdos previos, los gastos y las circunstancias personales deben analizarse antes de reclamar."
  - q: "¿Se puede obligar a vender?"
    a: "No se sustituye sin más la firma en una venta privada. Frente a una indivisión sin acuerdo puede pedirse la partición, cuyo resultado dependerá de los bienes y del proceso."
  - q: "¿Uno puede comprar la parte de los demás?"
    a: "Sí puede negociarse una adjudicación o adquisición de derechos con valuación, forma de pago e instrumentación adecuadas. No basta con un acuerdo verbal."
  - q: "¿Se puede cobrar alquiler al heredero que ocupa?"
    a: "El uso exclusivo puede originar reclamos, pero su procedencia, alcance y momento deben revisarse según las comunicaciones, acuerdos y circunstancias del caso."
  - q: "¿Qué documentación ayuda a negociar?"
    a: "Título, declaratoria, estado del expediente, tasaciones, impuestos, expensas, reparaciones, alquileres, comunicaciones y propuestas concretas permiten discutir sobre datos y no solo sobre posiciones."
---
...
Según la etapa y el objeto puede analizarse una **[cesión de derechos hereditarios](/cesion-derechos-hereditarios-cordoba/)**. No es idéntica a vender una porción registral del inmueble y requiere asesoramiento sobre alcance, forma y efectos.
...
<div class="d-flex flex-wrap gap-2 my-4">
  <a class="btn btn-primary" href="{{ site.contact.whatsapp_url }}?text={{ page.whatsapp_message | url_encode }}" target="_blank" rel="noopener" data-cta-channel="whatsapp" data-cta-location="article-mid">Analizar cómo destrabarlo</a>
  <a class="btn btn-outline-primary" href="/particion-herencia-cordoba/">Ver opciones de partición</a>
</div>
...
La **[guía sobre partición de herencia en Córdoba](/particion-herencia-cordoba/)** desarrolla la diferencia entre acuerdo, adjudicación y vía judicial.
...
También puede ayudar la guía **[cómo vender un inmueble heredado](/vender-inmueble-heredado-cordoba/)** para separar el conflicto familiar de los requisitos concretos de la operación.
