---
layout: article
title: "Tracto abreviado: requisitos y venta"
h1: "Tracto abreviado en Córdoba: qué es, requisitos y venta de inmuebles"
description: "Qué es el tracto abreviado en una sucesión, cuándo permite vender un inmueble, qué requisitos exige y quién afronta sus gastos en Córdoba."
primary_keyword: "tracto abreviado"
date: 2026-04-15
...
image:
  ...
  width: 1200
  height: 630
  alt: "Tracto abreviado en una sucesión de Córdoba"
reviewed_by:
  - pablo
  - gustavo
official_sources:
  ...
  - title: "Poder Judicial de Córdoba — venta de la casa heredada"
    url: "https://rjc.justiciacordoba.gob.ar/base-conocimiento-rjc/familia/herencias/estoy-declarado-heredero-junto-con-mis-hermanos-y-necesitamos-vender-la-casa-que-fue-de-mi-padre/"
quick: "El tracto abreviado no evita la sucesión ni reemplaza la declaratoria. Es una excepción al tracto sucesivo que, cuando se cumplen los requisitos legales y registrales, permite que determinados actos sobre un inmueble hereditario —por ejemplo, una venta— se inscriban directamente desde el titular fallecido hacia el adquirente, sin una inscripción intermedia a nombre de cada heredero."
faq:
  - q: "¿Qué es el tracto abreviado en una sucesión?"
    a: "Es una excepción registral que permite inscribir determinados actos sin registrar previamente el inmueble a nombre de los herederos. El documento final debe relacionar los antecedentes del dominio y cumplir los requisitos legales, judiciales, notariales y registrales del caso."
  - q: "¿El tracto abreviado evita hacer la sucesión?"
    a: "No. En una venta otorgada por herederos se necesita la base sucesoria correspondiente y, normalmente, que quienes transmiten estén judicialmente reconocidos. El tracto abreviado simplifica la cadena de inscripción; no elimina el proceso sucesorio."
  - q: "¿Se puede vender un inmueble por tracto abreviado?"
    a: "Sí, es uno de sus usos frecuentes: el inmueble puede inscribirse directamente a nombre del comprador si están cumplidos los presupuestos del artículo 16 de la Ley 17.801 y las exigencias del caso concreto. La viabilidad debe revisarse antes de comprometer la venta."
  - q: "¿Cuáles son los requisitos para una escritura por tracto abreviado?"
    a: "Entre otros datos, deben revisarse la declaratoria o el título sucesorio aplicable, el expediente, la matrícula y el título antecedente, la participación de todos los legitimados, certificados registrales y fiscales y las exigencias de la escritura. La documentación exacta depende del inmueble y de la operación."
  - q: "¿Quién paga el tracto abreviado?"
    a: "No existe una regla única que asigne todos los conceptos a una sola parte. Honorarios, certificados, impuestos, aportes y gastos de escritura o registración dependen de la operación, de las normas aplicables y de lo que legítimamente acuerden vendedor y comprador."
  - q: "¿Qué hacen el abogado y el escribano?"
    a: "El abogado impulsa y ordena la sucesión y las actuaciones judiciales necesarias. El escribano estudia los títulos, solicita certificados, prepara la escritura y presenta el documento registrable. Ambos deben coordinarse porque una etapa incompleta puede impedir la operación."
  - q: "¿Cuándo puede no resultar viable o conveniente?"
    a: "Puede no ser viable si todavía no están determinados los herederos, falta la conformidad necesaria, hay conflicto, restricciones o defectos en el título, medidas cautelares o documentación insuficiente. También puede no ser la alternativa más conveniente si primero debe resolverse una partición."
  - q: "¿Es lo mismo para inmuebles y automotores?"
    a: "No. Esta guía trata el tracto abreviado inmobiliario regulado por la Ley 17.801 y la normativa del Registro de la Propiedad. La transferencia de automotores responde a su propio régimen registral y debe analizarse por separado."
---
...
1. La [declaratoria de herederos](/declaratoria-de-herederos-cordoba/) reconoce judicialmente, en una sucesión intestada, a quienes acreditaron vocación hereditaria.
2. La [partición de la herencia](/particion-herencia-cordoba/) determina qué bienes concretos se adjudican a cada copartícipe y pone fin, total o parcialmente, a la indivisión.
3. El tracto abreviado permite instrumentar e inscribir ciertos actos sin una inscripción intermedia, siempre que exista continuidad jurídica y se cumplan los requisitos del caso.

Por eso no toda sucesión necesita una venta por tracto abreviado y no toda dificultad con un inmueble se resuelve de esa manera. Si todavía no están claros los porcentajes de los herederos, primero puede ser necesario [calcular cómo se reparte la herencia](/como-se-reparte-herencia-cordoba/).
...
Si primero necesitás entender la operación completa —acuerdo, publicación, reserva, documentación, escribanía y gastos— consultá **[cómo vender un inmueble heredado en Córdoba](/vender-inmueble-heredado-cordoba/)**. Esta página mantiene el foco técnico en el mecanismo registral del tracto abreviado.
...
Si faltan partidas o antecedentes, puede ser útil revisar la guía de [documentación para una sucesión](/documentacion-sucesion-cordoba/) o solicitar la [búsqueda de partidas para el expediente](/partidas-para-sucesion-cordoba/).
...
1. dónde tramita o tramitaría la sucesión;
2. si ya existe declaratoria u otra resolución sucesoria;
3. quién figura como titular del inmueble;
4. cuántos herederos intervienen y si están de acuerdo;
5. si existe comprador o solamente se está evaluando vender;
6. qué documentación del inmueble está disponible;
7. si se conocen gravámenes, deudas o problemas de título.

Con esos datos puede distinguirse si la dificultad está en la [sucesión](/sucesiones-cordoba/), la [partición](/particion-herencia-cordoba/), la escritura o la registración. También permite estimar qué documentación falta antes de generar gastos innecesarios. Para una revisión profesional podés consultar la página de [abogados de sucesiones en Córdoba](/abogado-sucesiones-cordoba/) o utilizar el [formulario de contacto](/contacto/).
