...
faq:
  - q: "¿Cuánto tarda “en meses” una declaratoria?"
    a: "No hay un número fijo. En general, un caso ordenado y sin conflicto suele demorar varios meses. Como referencia estadística oficial del Poder Judicial de Córdoba, el 79% de las declaratorias se resolvieron dentro del primer año desde su inicio; ese dato es orientativo y no constituye un plazo garantizado para cada caso."
  - q: "¿Qué es lo que más demora?"
    a: "Suele demorar: documentación con inconsistencias (nombres/fechas), herederos desorganizados o no localizados, informes vinculados a bienes (registros/bancos), observaciones del tribunal y conflicto entre herederos."
  - q: "¿Los edictos siempre impactan en el tiempo?"
    a: "En la sucesión intestada, la citación por edicto integra el trámite legal. Su incidencia práctica en el tiempo total puede variar según la publicación, las constancias que deban agregarse y las demás medidas del expediente."
  - q: "¿La declaratoria ya me permite vender un inmueble?"
    a: "Suele ser un paso clave, pero después normalmente vienen trámites registrales y, según el caso, acuerdos entre herederos, partición o etapas posteriores."
...
No hay un plazo único. El tiempo de una declaratoria en Córdoba depende del tribunal competente, la documentación, la citación por edictos en la sucesión intestada, los informes/oficios, el tipo de bienes y si existen observaciones o conflicto.
...
Como **referencia estadística oficial orientativa**, el Poder Judicial de Córdoba informó para el período **enero 2024 a junio 2025** que el **79%** de las declaratorias de herederos se resolvieron dentro del **primer año** desde su inicio, con una **mediana de 182 días corridos**. Además, para las declaratorias tramitadas en la **Oficina de Procesos Sucesorios (OPS)** de Córdoba Capital, el informe reportó un **promedio de 186 días corridos** en las causas terminadas relevadas. Estos datos son estadísticos y **no implican un plazo garantizado** para cada expediente.
...
El circuito puede variar según la sede y el tribunal competente. En la práctica:

- **Córdoba Capital:** las nuevas declaratorias de herederos se tramitan íntegramente en la **Oficina de Procesos Sucesorios (OPS)**, cada una a cargo de su juez competente.
- **Interior:** en términos generales, la tramitación suele radicarse ante juzgados con competencia civil/comercial del distrito correspondiente, según el **último domicilio del causante**.
...
Si estás en el interior o vivís fuera de Argentina: **[cómo organizar una sucesión en Córdoba a distancia](/sucesion-cordoba-desde-el-exterior/)**.
