...
faq:
  - q: "¿Herencia yacente y herencia vacante significan lo mismo?"
    a: "No son expresiones idénticas. 'Yacente' suele describir la herencia mientras todavía no existe un heredero que la haya asumido o identificado; 'vacante' es la situación declarada judicialmente cuando no hay herederos aceptantes ni disposición testamentaria total."
  - q: "¿Los bienes pasan automáticamente al Estado?"
    a: "No. Debe existir un proceso, una declaración judicial de vacancia, inventario, pago de deudas y legados y liquidación. Concluida esa etapa, el juez ordena entregar los bienes al Estado que corresponda."
  - q: "¿Qué pasa si aparece un heredero después?"
    a: "Puede promover una petición de herencia. Deberá acreditar su derecho y recibe los bienes en el estado en que se encuentren; la ley considera al Estado poseedor de buena fe."
  - q: "¿Un vecino o cuidador puede quedarse con la herencia?"
    a: "No por haber cuidado el bien, tener llaves o pagar servicios. Esos hechos no convierten automáticamente a la persona en heredera, sin perjuicio de otros derechos que eventualmente pueda acreditar."
  - q: "¿Los acreedores pierden sus créditos?"
    a: "No necesariamente. El curador debe inventariar los bienes y, con autorización judicial, pagar deudas y legados conforme las reglas aplicables y la suficiencia del patrimonio."
  - q: "¿Cómo se verifica si realmente no existen herederos?"
    a: "Se reconstruye la familia, se revisan partidas, edictos, expedientes y posibles testamentos. La ausencia de familiares conocidos no basta por sí sola para concluir que la herencia está vacante."
---
...
El [Código Civil y Comercial actualizado](https://www.argentina.gob.ar/normativa/nacional/ley-26994-235975/actualizacion) establece que, si no hay herederos aceptantes y el causante no distribuyó todos los bienes mediante legados, puede declararse judicialmente la **herencia vacante**.
...
Si la dificultad es una filiación no asentada o discutida, consultá [qué derechos puede tener un hijo no reconocido](/hijo-no-reconocido-herencia/).

## Cómo se investiga si existen herederos

Una reconstrucción razonable puede incluir:

1. Partida de defunción y último domicilio.
2. Partidas de nacimiento y matrimonio.
3. Datos de hijos, padres, cónyuge y otros parientes.
4. Expedientes sucesorios previos o conexos.
5. Edictos y registros disponibles.
6. Existencia de testamento.
7. Documentos extranjeros, si hubo familia o residencia fuera del país.
...
Recién después de reconstruir la familia y revisar el caso puede determinarse si corresponde una [sucesión sin testamento](/sucesion-sin-testamento-cordoba/) ordinaria o si existe base para la vacancia.
...
1. No disponer de los bienes ni retirar documentación sin autorización.
2. Preservar partidas, escrituras, recibos y datos bancarios.
3. Verificar si existe expediente sucesorio.
4. Identificar último domicilio y posibles familiares.
5. Revisar si hubo testamento.
6. Definir quién consulta y con qué interés jurídico.

Para localizar una causa de Córdoba Capital, puede servir la guía sobre la [Oficina de Procesos Sucesorios](/oficina-procesos-sucesorios-cordoba/). Para ordenar los documentos, utilizá el [checklist sucesorio](/documentacion-sucesion-cordoba/). Si necesitás revisar un supuesto concreto, podés solicitar una [evaluación profesional](/abogado-sucesiones-cordoba/) o escribir desde [contacto](/contacto/).
