...
faq:
  - q: "¿Se puede iniciar una sucesión si no hay testamento?"
    a: "Sí. En términos generales, la falta de testamento no impide iniciar el trámite sucesorio. Lo que cambia es que habrá que acreditar quiénes heredan según la ley y avanzar, si corresponde, hacia la declaratoria de herederos."
  - q: "¿Quién hereda si no hay testamento?"
    a: "En términos generales, la ley establece un orden de llamamiento hereditario. El alcance concreto puede variar según quiénes existan efectivamente, el vínculo y la situación del caso."
  - q: "¿Hace falta igual la declaratoria?"
    a: "Muchas veces sí, porque suele ser la resolución que permite reconocer judicialmente a los herederos cuando no hay testamento. Después pueden venir otras gestiones sobre bienes."
  - q: "¿Qué documentación suele pedirse?"
    a: "Suele ser útil contar con acta o partida de defunción, partidas que acrediten vínculos, datos de herederos y un mapa básico de los bienes. El detalle puede variar según el caso."
  - q: "¿Cambia algo si hay inmueble?"
    a: "Sí. Cuando hay bienes registrables, muchas veces el objetivo no termina en la declaratoria, sino que después hay que analizar inscripción, adjudicación, partición o eventualmente venta."
  - q: "¿Puede hacerse si un heredero vive afuera?"
    a: "En muchos casos sí, aunque suele requerir más coordinación práctica. El modo concreto depende del caso y de cómo deba acreditarse la participación de ese heredero."
  - q: "¿Cuánto puede tardar?"
    a: "No hay un plazo único. Los tiempos dependen del tribunal, la documentación, los bienes involucrados y si surgen observaciones o conflictos."
  - q: "¿Qué conviene hacer primero?"
    a: "Lo más útil suele ser ordenar tres cosas: quiénes serían herederos, si realmente no hay testamento, y qué bienes o trámites concretos hay que resolver."
---

## Respuesta rápida
Si no hay testamento, la sucesión igual puede tramitarse. En términos generales, habrá que acreditar quiénes heredan según la ley, reunir la documentación básica y encauzar el caso por la vía que corresponda. Si querés una visión más amplia del tema, podés empezar por esta [guía de sucesiones en Córdoba](/sucesiones-cordoba/).
...
Eso no significa que “no se pueda hacer nada” ni que los bienes queden automáticamente trabados para siempre. Significa, más bien, que habrá que determinar quién hereda según las reglas legales aplicables y avanzar con el [trámite sucesorio en Córdoba](/sucesiones-cordoba/) de acuerdo con las circunstancias concretas.
...
Por eso, si tu duda principal es “no hay testamento, ¿cómo se determina quién hereda?”, esta página y la del [trámite de declaratoria](/declaratoria-de-herederos-cordoba/) se complementan: acá se ordena el problema de base y allá se profundiza en esa etapa específica.
...
5. **Avanzar, si corresponde, hacia el reconocimiento judicial de herederos**  
   Ahí aparece muchas veces la [declaratoria de herederos en Córdoba](/declaratoria-de-herederos-cordoba/).

6. **Resolver el objetivo real del caso**  
...
No hace falta tener todo perfecto, pero sí conviene saber qué falta, qué existe y qué hay que pedir primero. Para eso sirven estos [papeles para iniciar el trámite](/documentacion-sucesion-cordoba/).

### 4. Pensar que la declaratoria “termina” el problema
Muchas veces no. Si hay bienes, puede venir después la etapa de inscripción, adjudicación, [partición de herencia en Córdoba](/particion-herencia-cordoba/) o incluso la necesidad de analizar cómo [vender un inmueble de sucesión](/tracto-abreviado-cordoba/), según corresponda.

### 5. Postergar una revisión inicial por miedo a no tener todo
Con una mirada temprana muchas veces se evita perder tiempo en pasos que después hay que rehacer. Si querés, podés [consultá por tu caso](/abogado-sucesiones-cordoba/).
...
Sí. Cuando hay inmueble, muchas veces el caso no termina en la declaratoria, sino que luego hay que evaluar inscripción, adjudicación, [cómo salir de la indivisión hereditaria](/particion-herencia-cordoba/) o eventualmente la vía para [inscripción y venta de inmueble hereditario](/tracto-abreviado-cordoba/).
