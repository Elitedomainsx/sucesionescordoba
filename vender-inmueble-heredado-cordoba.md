---
layout: article
title: "Vender un inmueble heredado en Córdoba"
title_category: "Casa o propiedad en sucesión"
seo_title: "Cómo vender una casa heredada en Córdoba"
h1: "Cómo vender una casa o inmueble heredado en Córdoba"
description: "Qué se necesita para vender una casa heredada en Córdoba, cuándo puede usarse tracto abreviado y qué hacer antes de firmar una reserva."
primary_keyword: "vender inmueble heredado"
page_topic: "vender_inmueble_heredado"
date: 2026-09-02
...
image:
  ...
  width: 1200
  height: 630
  alt: "Venta de una casa heredada en Córdoba"
reviewed_by:
  - pablo
  - gustavo
official_sources:
...
quick: "Una casa heredada puede venderse cuando se reúne la legitimación, el acuerdo y la documentación necesarios. Según el estado del expediente, puede inscribirse primero o coordinarse una venta por tracto abreviado. Antes de aceptar una reserva conviene confirmar que la operación es jurídicamente viable."
whatsapp_message: "Hola, necesito evaluar la venta de un inmueble heredado en Córdoba. La sucesión está en etapa ___, somos ___ herederos y queremos ___."
whatsapp_cta_label: "Evaluar cómo vender el inmueble"
cta_title: "¿Quieren vender una propiedad heredada?"
cta_copy: "Contanos dónde está, quién figura como titular, cuántos herederos intervienen, en qué etapa está la sucesión y si ya existe comprador."
faq:
  - q: "¿Se puede vender una casa sin hacer la sucesión?"
    a: "No corresponde transferir como titular a quien no lo es. Debe organizarse el proceso sucesorio y la instrumentación necesaria para que intervengan las personas legitimadas."
  - q: "¿Hay que inscribir primero a nombre de los herederos?"
    a: "No en todos los casos. Puede evaluarse una venta por tracto abreviado si se cumplen los requisitos. En otros escenarios conviene o resulta necesario inscribir primero."
  - q: "¿Puede vender uno solo de los herederos?"
    a: "Un heredero no puede por sí solo vender el inmueble completo como si fuera su único dueño. Deben analizarse los derechos existentes y la intervención de todos los legitimados."
  - q: "¿Se puede publicar la propiedad antes de terminar?"
    a: "Puede prepararse comercialmente, pero antes de asumir compromisos debe verificarse el estado jurídico, los tiempos y las condiciones bajo las cuales podría escriturarse."
  - q: "¿Qué ocurre si un heredero no quiere vender?"
    a: "Deben evaluarse negociación, adjudicación a quien quiere conservar, compensación, cesión o partición. No conviene prometer la venta total sin resolver el desacuerdo."
  - q: "¿Quién paga los gastos de la venta?"
    a: "Depende de la naturaleza del gasto, la normativa, las prácticas aplicables y el acuerdo contractual. Debe distinguirse lo sucesorio de lo registral, notarial, tributario e inmobiliario."
---
...
Si una persona quiere conservar el bien, puede estudiarse una adjudicación con compensación. Si el desacuerdo persiste, habrá que analizar la partición y otras vías. Consultá **[qué hacer si un heredero no quiere vender](/heredero-no-quiere-vender/)**.
...
<div class="d-flex flex-wrap gap-2 my-4">
  <a class="btn btn-primary" href="{{ site.contact.whatsapp_url }}?text={{ page.whatsapp_message | url_encode }}" target="_blank" rel="noopener" data-cta-channel="whatsapp" data-cta-location="article-mid">Revisar si la venta es viable</a>
  <a class="btn btn-outline-primary" href="/sucesion-casa-cordoba/">Ver la guía sobre la casa</a>
</div>
...
Antes de comparar alternativas, pedí que cada profesional identifique sus conceptos y quién los afrontará. Consultá **[cómo se calculan los costos de una sucesión](/cuanto-cuesta-sucesion-cordoba/)**.
