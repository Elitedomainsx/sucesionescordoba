...
Este sitio brinda información general sobre sucesiones y declaratoria de herederos en Córdoba (Argentina), con fines orientativos.

## 2) No constituye asesoramiento jurídico
La lectura de este sitio **no crea una relación abogado–cliente**. La estrategia, plazos y costos dependen del caso concreto.  
Para una orientación personalizada, coordinamos una consulta inicial.

## 3) Sin promesas de resultados, plazos ni montos
