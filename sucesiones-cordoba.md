...
faq:
  - q: "¿Sucesión y declaratoria de herederos es lo mismo?"
    a: "No. La sucesión es el **proceso judicial**. La declaratoria de herederos es una **resolución** propia de la sucesión intestada, que reconoce quiénes acreditaron vocación hereditaria. Además, la declaratoria no equivale por sí sola a partición ni a adjudicación final de bienes: según el objetivo (inmueble, auto, cuentas, venta), suelen venir etapas posteriores."
  - q: "¿Dónde se tramita en Córdoba Capital y en el interior?"
    a: "La competencia sucesoria se determina, en principio, por el **último domicilio del causante**. En **Córdoba Capital** funciona la **Oficina de Procesos Sucesorios (OPS)**. En el **interior**, en términos generales, tramita ante los juzgados con competencia **civil y comercial** que correspondan según la sede competente."
  - q: "¿Qué documentación necesito juntar primero?"
    a: "Como base: **acta/partida de defunción**, **partidas para acreditar vínculo** (nacimiento/matrimonio según corresponda), datos de herederos y el **último domicilio** del causante. Para bienes, alcanza inicialmente con datos orientativos (dirección o matrícula si se conoce, dominio del automotor, banco, caja de ahorro o inversión)."
  - q: "¿Cuánto tarda una sucesión en Córdoba?"
    a: "No hay un plazo único. Un caso ordenado y sin conflicto suele demorar **varios meses**; si hay observaciones, bienes complejos, herederos en distintas jurisdicciones, testamento o conflicto, puede extenderse **más**."
  - q: "¿Cuánto cuesta?"
    a: "No hay un número único. Se compone de **honorarios profesionales** y **gastos del proceso** (edictos en la sucesión intestada, informes, oficios, certificaciones, tasas o trámites registrales, según el caso). Depende de los bienes, la documentación disponible, la cantidad de herederos y el nivel de conflicto."
  - q: "¿Puedo iniciar si todavía no tengo todos los papeles?"
    a: "Muchas veces sí, pero no conviene iniciar a ciegas. Las inconsistencias o faltantes en partidas, datos personales o bienes suelen generar observaciones y demoras. En la consulta inicial conviene definir qué falta y en qué orden pedirlo."
  - q: "¿El conviviente hereda igual que el cónyuge?"
    a: "No por el solo hecho de convivir. La unión convivencial no integra por sí sola el orden de vocación hereditaria intestada. Eso no impide que el conviviente supérstite pueda tener otros derechos específicos según el caso, como protección habitacional en los supuestos legales."
  - q: "¿Me conviene mandar partidas o DNI por WhatsApp?"
    a: "Para el **primer contacto**, mejor no. Para evaluar el caso alcanza con datos generales (localidad, herederos, testamento, bienes). La documentación se comparte después, cuando se coordina el canal adecuado y ya está claro qué hace falta."
---
