...
faq:
  - q: "Can I start an inheritance case in Córdoba if I live abroad?"
    a: "Yes. An heir's residence outside Argentina does not by itself prevent that person from starting or participating in the proceeding. Jurisdiction, representation, documents and signatures must be assessed for the individual matter."
  - q: "Do I have to travel to Argentina?"
    a: "Not necessarily. The initial consultation, case assessment, document planning and much of the court follow-up can be coordinated remotely. Any formal signature, original document or in-person step should be identified in advance."
  - q: "Will foreign documents need an apostille and translation?"
    a: "They may. The requirement depends on the country, issuing authority, type of document and its intended use in Argentina. A document not written in Spanish may also require a certified public translation."
  - q: "Will I need a power of attorney?"
    a: "It may be necessary or useful, but its wording and execution method should be reviewed before it is signed. Depending on the country, it may be executed before an Argentine consulate or a local authority, with an apostille, legalization and translation where applicable."
  - q: "Can assets owned by the deceased be investigated?"
    a: "Yes. If there is no reliable inventory, a progressive search can be planned through official property, vehicle and other relevant registries. Private databases can provide leads, but their information must be verified through official sources."
  - q: "How can I find out whether another relative already opened the case?"
    a: "A search can be conducted using the deceased person's details and the likely jurisdiction. Before filing a new case, it is prudent to check whether a proceeding already exists, where it is pending and who has appeared."
  - q: "How are legal fees and third-party expenses handled?"
    a: "Legal fees should be distinguished from third-party expenses such as certificates, apostilles, translations, registry reports, notices and court requests. A proposed expense can be explained and approved before it is incurred."
  - q: "Can the entire proceeding be completed online?"
    a: "This cannot be guaranteed in every case. Many steps are remote, but formal signatures, certifications, original documents, consular arrangements or acts before banks and registries may still be required."
---
...
1. **What was the deceased person's actual last domicile?** This is central to jurisdiction.
2. **Does an inheritance case already exist?** Another family member may have filed it without informing every heir.
3. **Who may be entitled to inherit?** Family relationships and legally relevant events must be reconstructed.
4. **Is there a will?** A will may change the procedural route and scope of the case.
5. **What assets and liabilities may exist?** A preliminary asset map can be prepared even with incomplete records.
6. **Who holds information or documents concerning the estate?** Contracts, receipts and title information may be held by another relative.
7. **What does the heir need to achieve?** Recognition as an heir, a sale, an allocation of assets, collection of funds or information about the estate involve different steps.
...
1. **Signing a generic power of attorney before defining the goal.**
2. **Paying for broad searches without setting priorities.**
3. **Assuming no case exists because nobody disclosed it.**
4. **Apostilling or translating a document before its intended use is checked.**
5. **Confusing recognition as an heir with final allocation of the assets.**
6. **Sending sensitive identity documents in the first message.**
7. **Instructing third-party expenses without a budget and prior approval.**
...
👉 **[Contact us on WhatsApp](https://wa.me/{{ site.contact.whatsapp_number }}?text=Hello%2C%20I%20live%20in%20____%20(country)%20and%20need%20advice%20about%20an%20inheritance%20case%20in%20C%C3%B3rdoba.%20The%20deceased%27s%20last%20domicile%20was%20____.%20My%20relationship%20is%20____.%20The%20assets%20I%20know%20about%20are%20____.)**<br>
👉 **[Send an email]({{ site.contact.email_url }})**
