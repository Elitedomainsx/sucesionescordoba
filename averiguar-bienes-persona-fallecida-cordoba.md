---
layout: article
title: "Cómo averiguar bienes de una persona fallecida en Córdoba"
h1: "¿Cómo averiguar los bienes de una persona fallecida en Córdoba?"
description: "Búsqueda y relevamiento de bienes de una persona fallecida en Córdoba: inmuebles, automotores, informes, deudas y próximos pasos."
primary_keyword: "averiguar bienes de una persona fallecida"
date: 2026-09-01
...
image:
  ...
  width: 1200
  height: 630
  alt: "Búsqueda de bienes de una persona fallecida en Córdoba"
reviewed_by:
  - pablo
  - gustavo
...
official_sources:
  ...
  - title: "DNRPA — informe nominal nacional del automotor"
    url: "https://www.argentina.gob.ar/node/41037"
  - title: "Poder Judicial de Córdoba — Oficios Electrónicos"
    url: "https://www.justiciacordoba.gob.ar/JusticiaCordoba/Inicio/fileAdjunto.aspx?id=22085"
quick: "Si no sabés de qué se compone una herencia, se puede organizar una búsqueda progresiva de bienes vinculados con Córdoba. Primero se reúnen los datos disponibles; después se define qué informes registrales o medidas justificadas conviene pedir. No existe una consulta única que revele todo el patrimonio ni puede prometerse un resultado exhaustivo, pero sí puede construirse un mapa documentado para decidir cómo avanzar."
faq:
  - q: "¿Se puede averiguar qué bienes tenía una persona fallecida?"
    a: "Sí, se pueden realizar búsquedas e informes sobre bienes y derechos vinculados con Córdoba, siempre dentro de las vías legales y de la información disponible. No existe una base pública única que muestre todo el patrimonio, por lo que la investigación se organiza por etapas."
  - q: "¿Puedo contratar solamente la búsqueda de bienes?"
    a: "Sí. El relevamiento inicial puede contratarse por separado, sin encomendar necesariamente todo el proceso sucesorio. Su alcance, los informes y los gastos se definen antes de comenzar."
  - q: "¿Pueden buscar inmuebles si no tengo la escritura?"
    a: "Muchas veces se puede empezar con nombre, documento, domicilio, datos catastrales, impuestos o una dirección aproximada. La posibilidad y el tipo de informe dependen de la información disponible y de las reglas del registro competente."
  - q: "¿Se puede saber si tenía automotores?"
    a: "Existen informes oficiales de la DNRPA que pueden servir para comprobar titularidades. El pedido adecuado depende de si se conoce el dominio o si la búsqueda debe realizarse a partir de los datos de la persona."
  - q: "¿Pueden averiguar en qué bancos tenía cuentas?"
    a: "No existe una consulta pública irrestricta de cuentas bancarias. Según el caso, el expediente y la información previa, puede analizarse si corresponde solicitar oficios o medidas judiciales dirigidas a entidades u organismos determinados."
  - q: "¿La búsqueda incluye deudas y gravámenes?"
    a: "Los informes sobre bienes identificados pueden revelar embargos, hipotecas, prendas u otras afectaciones registrales. Las deudas no registradas y la situación completa del pasivo requieren otras fuentes y no siempre pueden conocerse de antemano."
  - q: "¿Puedo solicitar el relevamiento si vivo fuera de Córdoba?"
    a: "Sí. La evaluación, la autorización de gastos y la entrega de resultados pueden coordinarse a distancia. El servicio se concentra en bienes y registros vinculados con Córdoba."
  - q: "¿La búsqueda garantiza que aparecerán todos los bienes?"
    a: "No. El resultado depende de la calidad de los datos, de los registros consultables y de las medidas legalmente disponibles. Se informa qué se verificó, qué resultado arrojó y qué aspectos permanecen pendientes o requieren una actuación distinta."
---
...
Este relevamiento puede contratarse como servicio independiente. Si después hace falta iniciar o continuar el expediente, podés consultar la [guía general de sucesiones en Córdoba](/sucesiones-cordoba/) y la explicación sobre la [declaratoria de herederos](/declaratoria-de-herederos-cordoba/).
...
El relevamiento inicial puede contratarse sin encargar la sucesión completa. Para comprender otros componentes económicos, consultá [cuánto cuesta una sucesión en Córdoba](/cuanto-cuesta-sucesion-cordoba/).
...
Para el cálculo jurídico, consultá [cómo se reparte una herencia en Córdoba](/como-se-reparte-herencia-cordoba/). Para ordenar los papeles disponibles, usá el [checklist de documentación sucesoria](/documentacion-sucesion-cordoba/).
