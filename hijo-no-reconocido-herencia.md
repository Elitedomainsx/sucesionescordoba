...
faq:
  - q: "¿Los hijos no reconocidos pueden heredar?"
    a: "Sí, cuando queda jurídicamente determinada la filiación respecto del causante. A partir de allí, el hijo tiene los mismos derechos hereditarios que los demás hijos, sin distinción por haber nacido dentro o fuera del matrimonio."
  - q: "¿Cómo puede reclamar una herencia un hijo no reconocido?"
    a: "Si la filiación todavía no está determinada, puede ser necesario promover la acción correspondiente. Si el presunto progenitor falleció, la reclamación se dirige contra sus herederos. Después debe analizarse cómo incorporar o reconocer ese derecho dentro de la sucesión, según el estado del expediente."
  - q: "¿Qué herencia le corresponde a un hijo no reconocido?"
    a: "Una vez acreditado el vínculo, recibe la misma parte que cada uno de los otros hijos en la herencia de ese progenitor. El porcentaje sobre cada bien cambia según la cantidad de hijos, la existencia de cónyuge, el carácter propio o ganancial del bien, el porcentaje del causante y otras variables del caso."
  - q: "¿Un medio hermano hereda menos que los demás hijos?"
    a: "No en la sucesión del progenitor común. Si todos son hijos del mismo causante, heredan por partes iguales respecto de ese progenitor, aunque tengan distinta madre o distinto padre."
  - q: "¿Qué pasa si el padre ya falleció?"
    a: "La filiación extramatrimonial puede reclamarse contra los herederos del presunto progenitor fallecido. La prueba y el trámite dependen del caso; pueden resultar relevantes partidas, otros documentos y pruebas genéticas conforme a las reglas legales aplicables."
  - q: "¿Puede reclamar si ya se dictó la declaratoria de herederos?"
    a: "Que exista una declaratoria no elimina por sí solo los derechos de quien acredita ser heredero. Según el estado del expediente y de los bienes, puede corresponder ampliar o adecuar actuaciones, obtener el reconocimiento de la calidad hereditaria o promover una petición de herencia."
  - q: "¿Una donación en vida puede afectar su parte?"
    a: "Puede hacerlo. Hay que reconstruir el patrimonio, identificar las donaciones computables y analizar colación, dispensa, mejora, porción disponible y eventual reducción. No alcanza con comparar aisladamente el valor de un inmueble donado con un tercio."
  - q: "¿Hay un plazo para reclamar?"
    a: "La acción de reclamación de filiación puede ser promovida por el hijo en todo tiempo y la petición de herencia tiene reglas propias. Sin embargo, los efectos patrimoniales y los derechos sobre bienes determinados pueden quedar alcanzados por prescripciones u otras defensas. Conviene analizar el caso sin demora."
---
...
1. **El vínculo ya está legalmente determinado.** El causante figura como progenitor en la partida de nacimiento, hubo reconocimiento formal o existe una sentencia firme de filiación. En ese caso, aunque la familia recién se entere de su existencia, jurídicamente no se trata de un hijo “sin reconocer”: es un hijo y debe ser considerado al determinar quiénes heredan.
2. **La filiación todavía no está determinada.** La persona sostiene que el fallecido era su progenitor, pero ese vínculo no surge de una partida, reconocimiento o sentencia. Antes o junto con el reclamo hereditario puede ser necesario promover la acción de filiación correspondiente.

Esta diferencia define qué documentación hace falta y cómo debe encararse el expediente. Si todavía no se inició el proceso, puede servir como contexto esta guía sobre [sucesión sin testamento en Córdoba](/sucesion-sin-testamento-cordoba/).
...
La [declaratoria de herederos en Córdoba](/declaratoria-de-herederos-cordoba/) es una etapa central de la sucesión intestada, pero no reemplaza estos controles.
...
También importa si los bienes siguen indivisos, si fueron adjudicados o vendidos y si intervinieron terceros. Una consulta temprana permite identificar qué puede resolverse dentro del expediente y qué requiere una acción distinta. Para una revisión inicial, podés ver cómo trabaja un [abogado de sucesiones en Córdoba](/abogado-sucesiones-cordoba/).
...
Podés ordenar estos elementos con el [checklist de documentación para una sucesión](/documentacion-sucesion-cordoba/). En el primer contacto no hace falta enviar partidas, DNI ni documentación sensible por canales inseguros.

---

## Base legal de esta orientación

La explicación se apoya en el [Código Civil y Comercial de la Nación actualizado](https://www.argentina.gob.ar/normativa/nacional/ley-26994-235975/actualizacion), especialmente en las reglas sobre igualdad de efectos de la filiación, reclamación de filiación, petición de herencia, colación y reducción de donaciones, sucesión de los hijos, concurrencia del cónyuge y protección de la legítima.

La aplicación concreta depende de los instrumentos, las fechas, la situación de los bienes y el estado procesal. Si necesitás ordenar esas variables, podés solicitar una [evaluación profesional del caso](/contacto/) sin remitir documentación sensible en el primer mensaje.
